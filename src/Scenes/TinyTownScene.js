class TinyTown extends Phaser.Scene {
    ...
    create() {
        ...
        this.objectLayer = this.map.createLayer("Objects-n-Things", this.tileset, 0, 0);
        this.grassLayer.setScale(4.0);
        this.treeLayer.setScale(4.0);
        this.objectLayer.setScale(4.0);



        document.getElementById('description').innerHTML = '<h2>Welcome to Sashaeaton</h2>'
    }
